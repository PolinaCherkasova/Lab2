...
class PrintOperatorUnit : public Unit  // Класс PrintOperatorUnit, наследуемый от Unit, для генерации текста в методах класса
{
...
public:
    explicit PrintOperatorUnit(const string& text) : m_text(text) { } // Конструктор явного преобразования (explicit) принимает строку текста text
