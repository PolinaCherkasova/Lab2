...
class CPlusPlusClass : public ClassUnit // Класс для создания конкретного продукта - класса на с++
{
public:
    CPlusPlusClass(const string& name) : ClassUnit(name) {} // Определение пустого конструктора, который принимает константную строковую ссылку
