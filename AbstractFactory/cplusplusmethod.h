#ifndef CPLUSPLUSMETHOD_H
#define CPLUSPLUSMETHOD_H
#include "methodunit.h"

class CPlusPlusMethod : public MethodUnit // Класс для создания конкретного продукта - метода на с++
{
public:
    CPlusPlusMethod(const string& name, const string& returnType, Flags flags) : MethodUnit(name, returnType, flags) {} //Определение пустого конструктора,
