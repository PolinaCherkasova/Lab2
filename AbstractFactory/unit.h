...
class Unit //абстрактный класс, содержащий чисто-виртуальный метод, который будет переопределен в производных классах, где создаются конкретные продукты
{
public:
    using Flags = unsigned int; //тип индекса модификатора, принимающший беззнаковое целое значение
